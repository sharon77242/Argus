...
describe('SlowQueryMonitor', () => {
  ...
  it('getThreshold returns per-driver override over built-in default', () => {
    monitor = new SlowQueryMonitor({ defaultThresholdMs: 1000, thresholds: { pg: 200, redis: 25 } });
  ...
  describe('missing-driver warning', () => {
    ...
    beforeEach(() => {
      ...
      process.emitWarning = (warning, options?) => {
        ...
        originalEmitWarning.call(process, warning, options as Parameters<typeof process.emitWarning>[1]);
      };
    });
