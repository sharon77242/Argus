...
describe('EntropyChecker', () => {
  ...
  it('should scrub high entropy JWTs and Bearer tokens', () => {
    ...
    const input = 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWJqZWN0IjoidXNlcjEyMyIsImFkbWluIjp0cnVlfQ.v_YxM7N6qxwHkRbJgBfZ1L9K3d8TmP5Cz-A';
  ...
  it('should leave normal sentences and logs completely intact', () => {
    ...
    const input = 'This is exactly the type of normal sentence that we expect a monitoring engine to process without accidentally redacting standard console logs.';
    const scrubbed = EntropyChecker.scrubHighEntropyStrings(input);
